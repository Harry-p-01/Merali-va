...
function About() {
  return (
    <div style={{paddingTop: '80px'}}>
      ...
      {/* Hero Section */}
      <section style={{background: 'linear-gradient(135deg, #eff6ff 0%, #ffffff 100%)', padding: '80px 16px'}}>
        <div style={{maxWidth: '1152px', margin: '0 auto', textAlign: 'center'}}>
          ...
          >
            Bridging Asia and Africa Through <span style={{color: '#2563eb'}}>Strategic Trade</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <section style={{padding: '80px 16px', background: 'white'}}>
        <div style={{maxWidth: '1152px', margin: '0 auto', display: 'flex', flexWrap: 'wrap', gap: '48px', alignItems: 'center'}}>
          ...
          >
            <p style={{color: '#2563eb', fontWeight: '600', letterSpacing: '3px', textTransform: 'uppercase', marginBottom: '16px'}}>Our Mission</p>
          ...
          >
            {[
              ...
              <div key={index} style={{display: 'flex', gap: '16px', padding: '20px', background: '#eff6ff', borderRadius: '12px'}}>
      ...
      <section style={{padding: '80px 16px', background: '#eff6ff'}}>
        <div style={{maxWidth: '1152px', margin: '0 auto', textAlign: 'center'}}>
          <p style={{color: '#2563eb', fontWeight: '600', letterSpacing: '3px', textTransform: 'uppercase', marginBottom: '16px'}}>The Merali VA Advantage</p>
          ...
          <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '24px'}}>
            {[
              ...
              >
                <p style={{fontSize: '40px', fontWeight: '700', color: '#2563eb', marginBottom: '8px'}}>
                  <CountUp
                    end={stat.number}
                    duration={2}
                    suffix={stat.suffix}
